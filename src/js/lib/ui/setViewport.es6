...
// style.add('body{visibility:hidden;}html{width:100%;height:100%;background-image:url('+imgSrc+');background-size:'+55*dpr+'px '+59*dpr+'px;background-position:center center;background-repeat:no-repeat;background-color:#e8e8e8;}',id);
// setTimeout(function(){
